...
void TaskList::prettyPrint(std::ostream &os) {
	...
	for(it = head; it != nullptr; it = it->next)
	{
        it->data.print(os, maxTaskNameLen + 2, maxPersonNameLen + 2);
    }
    std::cout << std::endl;
}
...
void TaskList::listByName(std::ostream &os){
    os << "TODO: List by name" << std::endl;
}

void TaskList::listByType(std::ostream &os){
    os << "TODO: List by type" << std::endl;
}

void TaskList::searchByTaskName(std::ostream &os){
    os << "TODO: Search by task name" << std::endl;
}

void TaskList::removeByIndex(std::ostream &os){
    os << "TODO: Remove by index" << std::endl;
}
#endif
