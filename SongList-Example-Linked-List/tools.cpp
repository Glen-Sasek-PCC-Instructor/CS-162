...
void addSong(SongType &aSong)
{
    ...
    char PROMPT_DURATION[] = "Enter duration: ";
    char PROMPT_SONGNAME[] = "Enter a song name: ";
    char PROMPT_BPS[] = "Enter BPS: ";

    cout << PROMPT_SONGNAME;
    cin.get(tempTitle, MAXCHAR, '\n');
    cin.ignore(100, '\n');
    cout << "Enter artist: ";
    cin.getline(tempArtist, MAXCHAR);
    tempDuration = readInt(PROMPT_DURATION);
    tempBPS = readInt(PROMPT_BPS);
